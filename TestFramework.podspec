...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/nfl/TestFramework'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'nfl' => 'nfl0328@outlook.com' }
  s.source           = { :git => 'git@github.com:2017398956/TestFramework.git', :tag => s.version.to_s }
